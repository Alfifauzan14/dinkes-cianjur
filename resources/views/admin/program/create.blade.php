...
<div class="berita-admin-wrapper">
    <div class="admin-card">
        ...
        <form action="{{ route('admin.program-kesehatan.store') }}" method="POST" class="admin-form" style="display: flex; flex-direction: column; gap: 20px;">
            @csrf
            ...
            <div class="form-group" style="display: flex; flex-direction: column; gap: 8px;">
                <label for="slug" style="font-weight: 700; color: #1E293B;">Slug URL <span style="font-weight: 400; font-size: 12px; color: #94A3B8;">(Opsional, e.g. pencegahan-tb. Kosongkan untuk generate otomatis)</span></label>
                <input 
                    type="text" 
                    name="slug" 
                    id="slug" 
            ...
            <div style="border: 1px solid #E2E8F0; border-radius: 3px; padding: 20px; background-color: #F8FAFC; display: flex; flex-direction: column; gap: 16px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        ...
                        <input type="text" name="stat_1_num" id="stat_1_num" value="{{ old('stat_1_num') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px;" placeholder="Contoh: 12.5%">
                        <input type="text" name="stat_1_label" value="{{ old('stat_1_label') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px; margin-top: 6px;" placeholder="Label: Prevalensi Stunting">
                    </div>
                    <!-- Stat 2 -->
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <label for="stat_2_num" style="font-weight: 600; font-size: 13px; color: #475569;">Angka Indikator 2</label>
                        <input type="text" name="stat_2_num" id="stat_2_num" value="{{ old('stat_2_num') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px;" placeholder="Contoh: 3,200">
                        <input type="text" name="stat_2_label" value="{{ old('stat_2_label') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px; margin-top: 6px;" placeholder="Label: Balita Terpantau">
                    </div>
                    <!-- Stat 3 -->
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <label for="stat_3_num" style="font-weight: 600; font-size: 13px; color: #475569;">Angka Indikator 3</label>
                        <input type="text" name="stat_3_num" id="stat_3_num" value="{{ old('stat_3_num') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px;" placeholder="Contoh: 2,800">
                        <input type="text" name="stat_3_label" value="{{ old('stat_3_label') }}" style="padding: 8px 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-size: 14px; margin-top: 6px;" placeholder="Label: Keluarga Penerima">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <select name="status" id="status" class="form-control-select" style="padding: 10px; border: 1px solid #CBD5E1; border-radius: 3px; font-family: inherit; font-size: 14px; background-color: #fff;" required>
                    <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Published (Tampil di Menu Navbar)</option>
