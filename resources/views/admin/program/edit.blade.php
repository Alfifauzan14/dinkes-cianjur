                                    ...
                                    <div class="card-body p-3">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text bg-white text-success" style="border-right: none;">
                                                                <span class="material-icons" id="iprev-{{ $i }}" style="font-size: 16px;">{{ $itemIcon }}</span>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea name="intervensi_descs[]" rows="2" class="form-control"
                                                placeholder="Jelaskan detail kegiatan..." required>{{ $item['description'] ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @empty
                                    ...
                                    <div class="card bg-light border mb-3 mb-md-0">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="text-center mb-4">
                                                <h3 class="font-weight-bold mb-1" id="stat-num-preview-{{ $n }}" style="color: var(--brand-green); font-size: 28px;">{{ old($numKey, $program->$numKey) ?: '–' }}</h3>
                                                <span class="text-muted" id="stat-lbl-preview-{{ $n }}" style="font-size: 13px;">{{ old($lblKey, $program->$lblKey) ?: 'Label '.$n }}</span>
                                            </div>
                                            <div class="form-group">
