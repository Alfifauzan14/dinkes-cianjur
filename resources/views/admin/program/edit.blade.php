...
<div class="card card-outline card-success">
    <div class="card-header d-flex align-items-center justify-content-between">
        <span class="font-weight-bold text-muted" style="font-size:13px;">
            ...
            Mengedit: <em>{{ Str::limit($program->title, 50) }}</em>
        </span>
    ...
    <div class="card-body">
        <form action="{{ route('admin.program-kesehatan.update', $program->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-8">
                                    ...
                                    <div class="intervensi-row p-3 mb-2" style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:3px;position:relative;">
                                        ...
                                        <div style="padding-right:32px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="intervensi_titles[]" value="{{ $item['title'] }}" class="form-control form-control-sm" required>
                                            </div>
                                            <div class="form-group mb-0">
                                                <label style="font-size:12px;font-weight:600;">Deskripsi Kegiatan</label>
                                                <textarea name="intervensi_descs[]" rows="2" class="form-control form-control-sm" required>{{ $item['description'] }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" rows="8"
                            ...
                            placeholder="Contoh: <h3 class='st-content-title'>Definisi TB</h3><p class='st-content-text'>Tuberkulosis adalah...</p>">{{ old('content', $program->content) }}</textarea>
                        ...
                        <div class="card-body" style="padding:14px;">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $program->slug) }}"
                                    ...
                                    placeholder="Contoh: pencegahan-tb" required>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                                    <option value="published" {{ old('status', $program->status) == 'published' ? 'selected' : '' }}>Published (Tampil di Nav)</option>
                    ...
                    <div class="card mb-3" style="border:1px solid #E5E7EB;">
                        ...
                        <div class="card-body" style="padding:14px;">
                            ...
                            <div style="border-bottom:1px solid #E5E7EB;padding-bottom:12px;margin-bottom:12px;">
                                ...
                                <input type="text" name="stat_1_num" value="{{ old('stat_1_num', $program->stat_1_num) }}" class="form-control form-control-sm mb-1" placeholder="Angka, e.g. 12.5%">
                                <input type="text" name="stat_1_label" value="{{ old('stat_1_label', $program->stat_1_label) }}" class="form-control form-control-sm" placeholder="Label, e.g. Prevalensi Stunting">
                            </div>
                            {{-- Stat 2 --}}
                            <div style="border-bottom:1px solid #E5E7EB;padding-bottom:12px;margin-bottom:12px;">
                                <label>Indikator 2</label>
                                <input type="text" name="stat_2_num" value="{{ old('stat_2_num', $program->stat_2_num) }}" class="form-control form-control-sm mb-1" placeholder="Angka, e.g. 3,200">
                                <input type="text" name="stat_2_label" value="{{ old('stat_2_label', $program->stat_2_label) }}" class="form-control form-control-sm" placeholder="Label, e.g. Balita Terpantau">
                            </div>
                            {{-- Stat 3 --}}
                            <div class="mb-0">
                                <label>Indikator 3</label>
                                <input type="text" name="stat_3_num" value="{{ old('stat_3_num', $program->stat_3_num) }}" class="form-control form-control-sm mb-1" placeholder="Angka, e.g. 2,800">
                                <input type="text" name="stat_3_label" value="{{ old('stat_3_label', $program->stat_3_label) }}" class="form-control form-control-sm" placeholder="Label, e.g. Penerima PMT">
                            </div>
                        </div>
                    </div>
