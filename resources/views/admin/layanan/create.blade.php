    ...
    <div class="card-body">
        <form action="{{ route('admin.layanan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="6" placeholder="Jelaskan detail, prosedur, atau persyaratan pelayanan...">{{ old('description') }}</textarea>
                @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="requirements">Persyaratan Dokumen <span class="text-muted" style="font-weight:400;">(opsional)</span></label>
                <textarea name="requirements" id="requirements" class="form-control @error('requirements') is-invalid @enderror" rows="5" placeholder="Tuliskan persyaratan dokumen, pisahkan dengan baris baru (Enter)...">{{ old('requirements') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="procedures" id="procedures" class="form-control @error('procedures') is-invalid @enderror" rows="5" placeholder="Tuliskan alur & prosedur pengajuan, pisahkan dengan baris baru (Enter)...">{{ old('procedures') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="tariff" id="tariff" value="{{ old('tariff') }}"
