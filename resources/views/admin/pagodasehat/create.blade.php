...
<div class="card card-outline card-success">
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between" style="gap: 12px; padding: 16px 20px; background-color: #FFFFFF; border-bottom: 1px solid #E2E8F0;">
        <span class="d-flex align-items-center" style="gap: 8px;">
            ...
            <span class="font-weight-bold card-title-label">Tambah Kartu Pagoda Sehat</span>
        </span>
    ...
    <div class="card-body" style="padding: 24px;">
        <form action="{{ route('admin.pagodasehat.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="image" class="font-weight-bold" style="font-size: 13.5px; color: #1E293B;">Gambar Kartu <span class="text-danger">*</span></label>
                <input type="file" name="image" id="image" accept="image/*"
                    class="form-control-file @error('image') is-invalid @enderror" required>
                <small class="form-text text-muted">Format: PNG, JPG, WebP, SVG. Maks 5MB. Otomatis dikompresi.</small>
