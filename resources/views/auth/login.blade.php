        ...
        <div class="login-split-card">
            ...
            <div class="login-visual-panel">
                ...
                <div class="visual-header">
                    ...
                    <p class="visual-desc">Platform manajemen kesehatan terpadu yang menghubungkan data, pelayanan, dan masyarakat dalam satu sistem terintegrasi.</p>
                </div>

                <div class="visual-quote">
                    "Kesehatan bukan sekadar program — ia adalah janji kami kepada masyarakat Kabupaten Cianjur."
                </div>

                <!-- 5-Layer Wave SVG decoration -->
                <div class="waves-decor">
                    <svg class="wave-svg wave-1" viewBox="0 0 1440 200" preserveAspectRatio="none">
                        <path fill="#ffffff" fill-opacity="0.15" d="M0,80 C180,20 360,160 540,80 C720,0 900,140 1080,80 C1260,20 1350,60 1440,80 L1440,200 L0,200 Z"></path>
                    </svg>
                    <svg class="wave-svg wave-2" viewBox="0 0 1440 200" preserveAspectRatio="none">
                        <path fill="#ffffff" fill-opacity="0.15" d="M0,100 C120,160 300,20 480,100 C660,180 840,20 1020,100 C1200,180 1320,140 1440,120 L1440,200 L0,200 Z"></path>
                    </svg>
                    <svg class="wave-svg wave-3" viewBox="0 0 1440 200" preserveAspectRatio="none">
                        <path fill="#ffffff" fill-opacity="0.15" d="M0,60 C240,160 480,0 720,80 C960,160 1200,40 1440,100 L1440,200 L0,200 Z"></path>
                    </svg>
                    <svg class="wave-svg wave-4" viewBox="0 0 1440 200" preserveAspectRatio="none">
                        <path fill="#ffffff" fill-opacity="0.15" d="M0,120 C160,60 320,160 480,120 C640,80 800,160 960,100 C1120,40 1280,120 1440,80 L1440,200 L0,200 Z"></path>
                    </svg>
                    <svg class="wave-svg wave-5" viewBox="0 0 1440 200" preserveAspectRatio="none">
                        <path fill="#ffffff" fill-opacity="0.15" d="M0,140 C200,80 400,160 600,130 C800,100 1000,160 1200,130 C1300,115 1380,120 1440,110 L1440,200 L0,200 Z"></path>
                    </svg>
                </div>
            </div>
