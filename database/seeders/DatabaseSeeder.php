...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Seeding data Stunting Records
        $stuntingData = [
            ['year' => 2018, 'rate' => 4.2, 'is_highlighted' => false],
            ['year' => 2019, 'rate' => 16.2, 'is_highlighted' => false],
            ['year' => 2020, 'rate' => 4.8, 'is_highlighted' => false],
            ['year' => 2021, 'rate' => 18.2, 'is_highlighted' => false],
            ['year' => 2022, 'rate' => 9.8, 'is_highlighted' => false],
            ['year' => 2023, 'rate' => 14.7, 'is_highlighted' => false],
            ['year' => 2024, 'rate' => 18.2, 'is_highlighted' => false],
            ['year' => 2025, 'rate' => 14.7, 'is_highlighted' => false],
            ['year' => 2026, 'rate' => 9.8, 'is_highlighted' => true],
        ];

        foreach ($stuntingData as $record) {
            \App\Models\StuntingRecord::updateOrCreate(
                ['year' => $record['year']],
                ['rate' => $record['rate'], 'is_highlighted' => $record['is_highlighted']]
            );
        }
